...
const HeroSection = () => {
  ...
  const rocks = [
    { src: Rock1, side: "left" },
    { src: Rock2, side: "left" },
    { src: Rock3, side: "center", scale: 1.7 }, // BOM bigger in center
    { src: Rock4, side: "right" },
    { src: Rock5, side: "right" },
  ];
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-8 items-center">
          ...
          <div className="space-y-6 text-center lg:text-left">
            ...
            >
              Empowering decentralized finance through innovative solutions. Our
              mission is to provide users with tools to grow wealth and engage
              with financial services in a sustainable ecosystem.
            </motion.p>
        ...
        {/* Full-width Rocks Row - Above Contract */}
        <motion.div
          ...
          {rocks.map((rock, index) => (
            <motion.img
              ...
              animate={
                rock.side === "center"
                  ? {
                      // BOM continuous up-down motion
                      opacity: 1,
                      y: [0, -25, 0], // Small up-down motion (8px)
                      transition: {
                        duration: 2.5,
                        repeat: Infinity,
                        ease: "easeInOut",
              ...
              whileHover={{ 
                ...
                y: rock.side === "center" ? -10 : -10 // Keep hover lift for BOM too
              }}
            />
          ))}
        </motion.div>
